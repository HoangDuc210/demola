(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_admin_components_news_ListNews_jsx"],{
...
/***/ "./resources/js/admin/components/news/ListNews.jsx":
/*!*********************************************************!*\
  !*** ./resources/js/admin/components/news/ListNews.jsx ***!
  \*********************************************************/
...
function ListNews(props) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    axios__WEBPACK_IMPORTED_MODULE_2___default().get(domain + pathname + "/news").then(function (res) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              setPages(page);
              axios__WEBPACK_IMPORTED_MODULE_2___default().get(domain + pathname + "/news?page=" + page).then(function (res) {
  ...
  var updateActive = function updateActive(id) {
    ...
    var update = function update(data) {
      axios__WEBPACK_IMPORTED_MODULE_2___default().put(domain + pathname + "/news/" + id, data).then(function (res) {
  ...
  var deleteItem = function deleteItem(id) {
    axios__WEBPACK_IMPORTED_MODULE_2___default()["delete"](domain + pathname + "/news/" + id).then(function (res) {
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(domain + pathname + "/news?page=" + pages).then(function (res) {
        setNews(res.data.data);
